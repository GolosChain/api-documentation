...
|          |        |   curatorReward   |          |           | boolean |  Нет  | Оповещение о награде за установку лайка за пост/комментарий                                                                                                                                                                                                                                             |
|          |        | benefeciaryReward |          |           | boolean |  Нет  | Оповещение о награде за бенефициарство                                                                                                                                                                                                                                                                  |
...
|              | benefeciaryReward |           | string  |       | Попытаться получить бенефициарские награды                                                                               |
...
|              | benefeciaryReward |           | string  |       | Получить бенефициарские награды                   |
...
Апи предоставляет возможность пользователю запрашивать оплату за какие-либо транзакции у аккаунта-провайдера.
...
|     Процедура     | Авторизация | Описание                                                  |
| :---------------: | :---------: | --------------------------------------------------------- |
| bandwidth.provide | Обязателна  | Запросить оплату транзакции бендвичем системного аккаунта |

|  Параметр   |  Тип   | Обяз. |     По умолч. Описание     |
| :---------: | :----: | :---: | :------------------------: |
| transaction | string |  Да   | Сериализованная транзакция |
|   chainId   | string |  Да   |        Айди цепочки        |
