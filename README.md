...
|      Процедура       | Авторизация  | Описание                                                                        |
| :------------------: | :----------: | ------------------------------------------------------------------------------- |
| content.getPostVotes | Требуется для определенного функционала | Получение списка голосов за пост вместе с процентами использованной силы голоса |
...
|      Процедура       | Авторизация  | Описание                                                                        |
| :------------------: | :----------: | ------------------------------------------------------------------------------- |
| content.getCommentVotes | Требуется для определенного функционала | Получение списка голосов за коммент вместе с процентами использованной силы голоса |
